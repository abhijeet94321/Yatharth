      ...
      <Dialog open={isProfileDialogOpen} onOpenChange={setIsProfileDialogOpen}>
        ...
        <DialogContent>
            <DialogHeader>
                ...
                <DialogDescription>Update your name, profession, and contact details.</DialogDescription>
            </DialogHeader>
            <EditProfileForm userProfile={userProfile} onSave={() => setIsProfileDialogOpen(false)} />
        </DialogContent>
      </Dialog>
    </header>
  );
